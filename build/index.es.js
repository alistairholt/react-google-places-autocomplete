import React, { createContext, createElement, Fragment as Fragment$1, forwardRef, Component, PureComponent, useRef, useCallback, useEffect, useState } from 'react';
...
var makeAsyncSelect = function makeAsyncSelect(SelectComponent) {
  ...
  function (_Component) {
    ...
    _proto.render = function render() {
      ...
      return React.createElement(SelectComponent, _extends$d({}, props, {
        ref: function ref(_ref) {
          _this3.select = _ref;
        },
        options: options,
...
var makeCreatableSelect = function makeCreatableSelect(SelectComponent) {
  ...
  function (_Component) {
    ...
    _proto.render = function render() {
      ...
      return React.createElement(SelectComponent, _extends$e({}, this.props, {
        ref: function ref(_ref) {
          _this2.select = _ref;
        },
        options: options,
...
var GooglePlacesAutocomplete = function (_a) {
    ...
    var _j = useState(undefined), placesService = _j[0], setPlacesService = _j[1];
    var _k = useState(undefined), sessionToken = _k[0], setSessionToken = _k[1];
    ...
    return (React.createElement(AsyncCreatable, __assign({}, selectProps, { formatCreateLabel: function (value) { return value; }, loadOptions: fetchSuggestions, getOptionValue: function (_a) {
            var value = _a.value;
