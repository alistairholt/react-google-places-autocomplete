...
function (_Component) {
  ...
  _proto.renderInput = function renderInput() {
    ...
    if (!isSearchable) {
      ...
      return React__default['default'].createElement(DummyInput, _extends$4$1({
        id: id,
    ...
    return React__default['default'].createElement(Input, _extends$4$1({
      autoCapitalize: "none",
      autoComplete: "off",
      autoCorrect: "off",
      cx: cx,
  ...
  _proto.renderPlaceholderOrValue = function renderPlaceholderOrValue() {
    ...
    if (!this.hasValue() || !controlShouldRenderValue) {
      return inputValue ? null : React__default['default'].createElement(Placeholder, _extends$4$1({}, commonProps, {
        key: "placeholder",
        isDisabled: isDisabled,
        isFocused: isFocused
      }), placeholder);
    ...
    if (isMulti) {
      var selectValues = selectValue.map(function (opt, index) {
        ...
        return React__default['default'].createElement(MultiValue, _extends$4$1({}, commonProps, {
          components: {
    ...
    return React__default['default'].createElement(SingleValue, _extends$4$1({}, commonProps, {
      data: singleValue,
      isDisabled: isDisabled
  ...
  _proto.renderClearIndicator = function renderClearIndicator() {
    ...
    return React__default['default'].createElement(ClearIndicator, _extends$4$1({}, commonProps, {
  ...
  _proto.renderLoadingIndicator = function renderLoadingIndicator() {
    ...
    return React__default['default'].createElement(LoadingIndicator, _extends$4$1({}, commonProps, {
      innerProps: innerProps,
      isDisabled: isDisabled,
      isFocused: isFocused
    }));
  ...
  _proto.renderIndicatorSeparator = function renderIndicatorSeparator() {
    ...
    var isFocused = this.state.isFocused;
    return React__default['default'].createElement(IndicatorSeparator, _extends$4$1({}, commonProps, {
      isDisabled: isDisabled,
      isFocused: isFocused
    }));
  };
  ...
  _proto.renderDropdownIndicator = function renderDropdownIndicator() {
    ...
    return React__default['default'].createElement(DropdownIndicator, _extends$4$1({}, commonProps, {
      innerProps: innerProps,
      isDisabled: isDisabled,
      isFocused: isFocused
    }));
  ...
  _proto.renderMenu = function renderMenu() {
    ...
    var render = function render(props) {
      ...
      return React__default['default'].createElement(Option, _extends$4$1({}, commonProps, props, {
        isFocused: isFocused
    ...
    if (this.hasOptions()) {
      menuUI = menuOptions.render.map(function (item) {
        if (item.type === 'group') {
          ...
          return React__default['default'].createElement(Group, _extends$4$1({}, commonProps, group, {
    ...
    var menuElement = React__default['default'].createElement(MenuPlacer, _extends$4$1({}, commonProps, menuPlacementProps), function (_ref8) {
      var ref = _ref8.ref,
          _ref8$placerProps = _ref8.placerProps,
          placement = _ref8$placerProps.placement,
          maxHeight = _ref8$placerProps.maxHeight;
      return React__default['default'].createElement(Menu, _extends$4$1({}, commonProps, menuPlacementProps, {
        innerRef: ref,
        innerProps: {
      ...
      }, React__default['default'].createElement(MenuList, _extends$4$1({}, commonProps, {
    ...
    return menuPortalTarget || menuPosition === 'fixed' ? React__default['default'].createElement(MenuPortal, _extends$4$1({}, commonProps, {
  ...
  _proto.renderLiveRegion = function renderLiveRegion() {
    ...
    return React__default['default'].createElement(A11yText, {
      "aria-live": "polite"
    }, React__default['default'].createElement("p", {
      id: "aria-selection-event"
    }, "\xA0", this.state.ariaLiveSelection), React__default['default'].createElement("p", {
      id: "aria-context"
  ...
  _proto.render = function render() {
    ...
    return React__default['default'].createElement(SelectContainer, _extends$4$1({}, commonProps, {
      className: className,
      innerProps: {
        id: id,
      ...
      isDisabled: isDisabled,
      isFocused: isFocused
    }), this.renderLiveRegion(), React__default['default'].createElement(Control, _extends$4$1({}, commonProps, {
    ...
    }), React__default['default'].createElement(ValueContainer, _extends$4$1({}, commonProps, {
      isDisabled: isDisabled
    }), this.renderPlaceholderOrValue(), this.renderInput()), React__default['default'].createElement(IndicatorsContainer, _extends$4$1({}, commonProps, {
      isDisabled: isDisabled
...
var manageState = function manageState(SelectComponent) {
  ...
  function (_Component) {
    ...
    _proto.render = function render() {
      ...
      return React__default['default'].createElement(SelectComponent, _extends$c({}, props, {
...
var makeAsyncSelect = function makeAsyncSelect(SelectComponent) {
  ...
  function (_Component) {
    ...
    _proto.render = function render() {
      ...
      return React__default['default'].createElement(SelectComponent, _extends$d({}, props, {
        ref: function ref(_ref) {
          _this3.select = _ref;
        },
        options: options,
...
var makeCreatableSelect = function makeCreatableSelect(SelectComponent) {
  ...
  /*#__PURE__*/
  function (_Component) {
    _inheritsLoose$7(Creatable, _Component);
    ...
    _proto.render = function render() {
      ...
      return React__default['default'].createElement(SelectComponent, _extends$e({}, this.props, {
        ref: function ref(_ref) {
          _this2.select = _ref;
        },
        options: options,
...
function useDebouncedCallback(callback, delay, options) {
    ...
    var callPending = React.useCallback(function () {
...
var GooglePlacesAutocomplete = function (_a) {
    ...
    var _j = React.useState(undefined), placesService = _j[0], setPlacesService = _j[1];
    var _k = React.useState(undefined), sessionToken = _k[0], setSessionToken = _k[1];
    ...
    return (React__default['default'].createElement(AsyncCreatable, __assign({}, selectProps, { formatCreateLabel: function (value) { return value; }, loadOptions: fetchSuggestions, getOptionValue: function (_a) {
            var value = _a.value;
